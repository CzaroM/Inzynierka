...
public class NewPermamentOperationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_permament_operation);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(NewPermamentOperationActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        saveOperationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ischeckForm(radioButtonId)) {
                    ...
                    PermamentOperation permamentOperation = new PermamentOperation();
                    ...
                    databaseHelper.addPermamentOperation(permamentOperation);
...
//                startActivity(intent);
                    ...
                    Toast.makeText(NewPermamentOperationActivity.this, " nie wypełniono wszystkich pol w formularzu", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
